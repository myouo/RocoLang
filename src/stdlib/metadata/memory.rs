...
pub fn docs() -> Vec<StdlibFunctionDetails> {
    vec![
        super::stdlib_doc!(
            "memory", "today", return_type: "string",
            "返回持久化每日记忆当前使用的服务器日期。",
            params: [], returns: "YYYY-MM-DD 格式的服务器日期。",
            examples: ["print(memory::today());"]
        ),
        super::stdlib_doc!(
            "memory", "daily_get_int", return_type: "int",
            "读取当前账号和服务器日期下的整数值。",
